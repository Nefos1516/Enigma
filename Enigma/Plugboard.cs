...
namespace Enigma
{
    ...
    private ArrayList SteckerWiring = new ArrayList();
    private MainForm mainForm;
      ...
      this.Plug1.TextChanged += new EventHandler(this.Plug1TextChanged);
      ...
      this.Plug2.TextChanged += new EventHandler(this.Plug2TextChanged);
      ...
      this.Plug3.TabIndex = 14;
      this.Plug3.TextChanged += new EventHandler(this.Plug3TextChanged);
      ...
      this.Plug4.TabIndex = 13;
      this.Plug4.TextChanged += new EventHandler(this.Plug4TextChanged);
      ...
      this.Plug5.TabIndex = 12;
      this.Plug5.TextChanged += new EventHandler(this.Plug5TextChanged);
      ...
      this.Plug6.TabIndex = 11;
      this.Plug6.TextChanged += new EventHandler(this.Plug6TextChanged);
      ...
      this.Plug7.TabIndex = 9;
      this.Plug7.TextChanged += new EventHandler(this.Plug7TextChanged);
      ...
      this.Plug8.TabIndex = 8;
      this.Plug8.TextChanged += new EventHandler(this.Plug8TextChanged);
      ...
      this.Plug9.TabIndex = 7;
      this.Plug9.TextChanged += new EventHandler(this.Plug9TextChanged);
      ...
      this.Plug10.TabIndex = 6;
      this.Plug10.TextChanged += new EventHandler(this.Plug10TextChanged);
      ...
      this.Plug11.TabIndex = 5;
      this.Plug11.TextChanged += new EventHandler(this.Plug11TextChanged);
      ...
      this.Plug12.TabIndex = 4;
      this.Plug12.TextChanged += new EventHandler(this.Plug12TextChanged);
      ...
      this.Plug13.TabIndex = 15;
      this.Plug13.TextChanged += new EventHandler(this.Plug13TextChanged);
    ...
    private void Plug1TextChanged (object sender, EventArgs e)
    {
      if (Plug1.Text.Length == 2)
      {
        ...
        if (CharArray[0] == CharArray[1] || SteckerWiring.Contains(CharArray[0]) || SteckerWiring.Contains(CharArray[1]))
        {
          MessageBox.Show(this, "Введите две разные буквы!", "Внимание!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
          Plug1.Clear();
          return;
        }
        SteckerWiring.Add(CharArray);
      }
    }
    ...
    {
      for (int i = 0; i < SteckerWiring.Count; i++)
      {
